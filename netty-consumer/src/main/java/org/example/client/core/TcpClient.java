...
import org.example.client.constant.Constants;
import org.example.client.param.ClientRequest;
import org.example.client.handler.SimpleClientHandler;
            ...
            for(String serverPath : serverPaths){
                ...
                if(weight>0){
                    for (int w=0;w<weight;w++){
                        ...
                        ChannelFuture channelFuture = b.connect(str[0],Integer.parseInt(str[1]));
